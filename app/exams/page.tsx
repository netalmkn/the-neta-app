      ...
      <main className="flex-1 lg:ml-56 min-h-screen">
        ...
        <div className="max-w-3xl mx-auto px-4 lg:px-12 py-8 pb-28 lg:pb-12">
          <div className="flex items-center justify-between mb-6">
            ...
            <button onClick={() => setModal(true)} className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-[13px] font-semibold transition-all active:scale-95" style={{ background: N.accent, color: "white", boxShadow: "0 2px 8px rgba(99,102,241,0.3)" }}><Ico.plus /> New exam</button>
          </div>
