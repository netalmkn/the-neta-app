...
const INITIAL_TASKS: Task[] = [
  {
    id: "1",
    name: "Linear Algebra — Problem Set 4",
    type: "homework",
  ...
  {
    id: "2",
    name: "Midterm: Organic Chemistry",
    type: "exam",
  ...
  },
  {
    ...
    type: "project",
    deadline: "Mar 15, 5:00 PM",
    done: false,
  },
  {
    id: "4",
    name: "Read Chapter 7 — Macroeconomics",
    type: "homework",
    deadline: "Mar 14, 8:00 PM",
    done: true,
  },
  {
    id: "5",
  ...
  return (
    ...
    >
      ...
      <button
        ...
        style={
          task.done
            ? { backgroundColor: badge.accent, borderColor: badge.accent }
            : { borderColor: "#CBD5E1" }
        }
...
function AddTaskModal({
  ...
  const handleAdd = () => {
    if (!name.trim()) return;
    onAdd({ name: name.trim(), type, deadline: deadline.trim() || "No deadline" });
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end">
      ...
      >
        ...
        <h3
          className="text-xl font-semibold text-[#0B1437] mb-5"
        ...
        <div className="space-y-3.5">
          ...
          <button
            onClick={handleAdd}
            className="w-full bg-[#0B1437] text-white py-4 rounded-2xl text-sm font-semibold tracking-wide active:scale-[0.98] transition-transform mt-1"
            style={{ fontFamily: "var(--font-outfit)" }}
          >
            Add Task
          </button>
...
export default function Home() {
  ...
  // Sort: undone first, then by original order
  const sorted = [
  ...
  return (
    <div className="min-h-screen" style={{ background: "#EEF1F8" }}>
      ...
      >
        ...
        />
        <div
          className="absolute -bottom-8 -left-8 w-36 h-36 rounded-full opacity-[0.04]"
          style={{ background: "#6B7FBF" }}
        />

        <p
          className="text-[11px] font-semibold uppercase tracking-[0.2em] mb-2"
          style={{ fontFamily: "var(--font-outfit)", color: "#4A5B9A" }}
        >
          {dayName}
        </p>

        <h1
          className="text-[2.6rem] font-semibold leading-[1.1] text-white mb-7"
          style={{ fontFamily: "var(--font-playfair)" }}
        >
          {dateStr}
        </h1>
      ...
      <div className="px-4 pt-5 pb-32 space-y-2.5">
        ...
        {tasks.length === 0 && (
          <div
            ...
            style={{ fontFamily: "var(--font-outfit)", color: "#9CA3AF" }}
          >
            <p className="text-3xl mb-3">✓</p>
            <p className="text-sm">All clear — add a task to get started.</p>
          </div>
        )}
      </div>
      ...
      <button
        ...
        style={{
          bottom: "calc(80px + 1.25rem)", // sits above bottom nav
          background: "#F5C518",
